const translations = {
  en: {
    ...
    adminPage: {
      ...
      breakdownUpcoming: 'Upcoming',
      breakdownInProgress: 'In progress',
      breakdownFinished: 'Finished',
      breakdownTitle: 'Event status breakdown',
      breakdownApproved: 'Approved',
      breakdownPending: 'Pending',
      breakdownRejected: 'Rejected',
      snapshotEyebrow: 'Platform snapshot',
      snapshotTitle: 'Live admin overview',
      snapshotUsersNote: 'registered',
      snapshotEventsNote: 'all time',
      snapshotApprovedNote: '{rate}% of events',
      snapshotAttendedNote: 'check-ins',
      snapshotWaitlistedNote: 'in queue',
      snapshotNoShowsNote: '{rate}% miss rate',
      lifecycleTitle: 'Event lifecycle',
      lifecycleActive: 'Active',
      lifecycleFinished: 'Finished',
      lifecycleInProgress: 'In progress',
      funnelTitle: 'Participation funnel',
      funnelJoined: 'Joined',
      funnelAttended: 'Attended',
      funnelNoShow: 'No-show',
      funnelWaitlist: 'Waitlist',
      timelineTitle: 'Recent activity timeline — last 7 days',
      timelineJoins: 'New joins',
      timelineCheckIns: 'Check-ins',
      attendanceRateTitle: 'Attendance rate',
      attendanceRateSubtitle: 'of closed-event participants attended',
      ...
      broadcast: {
        sectionEyebrow: 'Messaging',
        sectionTitle: 'Broadcast announcements',
        sectionSubtitle:
          'Send email and in-app notifications to targeted users. Line breaks are preserved; HTML is stripped for safety.',
        subjectLabel: 'Subject',
        bodyLabel: 'Message',
        bodyHint: 'Plain text. Targeted users receive an in-app notification and an email when they have email alerts on.',
        recipientLabel: 'Recipients',
        recipientAll: 'All active users',
        recipientStudents: 'Students only',
        recipientOrganizers: 'Organizers only',
        recipientAdmins: 'Admins only',
        priorityLabel: 'Priority',
        priorityNormal: 'Normal',
        priorityHigh: 'High (adds [Important] to email subject)',
        templateLabel: 'Quick template',
        templateNone: 'None (blank)',
        templateMaintenance: 'Planned maintenance',
        templateWelcome: 'Welcome message',
        scheduleLabel: 'Send later (optional)',
        scheduleHint: 'Leave empty to send immediately. Scheduled sends require the server job process_scheduled_broadcasts.',
        submitSend: 'Send now',
        ...
        analyticsDeliveries: 'In-app deliveries',
        analyticsEmails: 'Emails sent',
        analyticsReads: 'Read in app',
        analyticsHint: 'Read counts update when users open notifications from the bell menu.',
        readRate: 'Read rate (approx.)',
        selectBroadcast: 'Select a broadcast from the list to see analytics.',
        subjectBodyRequired: 'Please enter both a subject and a message.',
        scheduleRequired: 'Pick a date and time to schedule a broadcast.',
      },
    },
    adminUsersPage: {
    ...
    eventForm: {
      ...
      categoryComboboxLabel: 'Category',
      categoryListLabel: 'Matching categories',
      toggleCategoryList: 'Show or hide category list',
      noCategoriesFound: 'No categories found',
      useGeneralCategory: 'Use General category',
      ...
      errors: {
        ...
        timeFormat: 'Time must be in HH:MM format (e.g., 18:30).',
  ...
  ru: {
    ...
    eventForm: {
      ...
      selectCategory: 'Выберите или введите категорию...',
      categoryComboboxLabel: 'Категория',
      categoryListLabel: 'Подходящие категории',
      toggleCategoryList: 'Показать или скрыть список категорий',
      noCategoriesFound: 'Категории не найдены',
      useGeneralCategory: 'Использовать категорию "Общее"',
      ...
      errors: {
        ...
        timeFormat: 'Время должно быть в формате ЧЧ:ММ (например, 18:30).',
  ...
  uz: {
    ...
    eventForm: {
      ...
      selectCategory: 'Kategoriyani tanlang yoki kiriting...',
      categoryComboboxLabel: 'Kategoriya',
      categoryListLabel: 'Mos kategoriyalar',
      toggleCategoryList: 'Kategoriya ro‘yxatini ochish yoki yopish',
      noCategoriesFound: 'Kategoriyalar topilmadi',
      useGeneralCategory: '"Umumiy" kategoriyasidan foydalaning',
      ...
      errors: {
        ...
        timeFormat: 'Vaqt HH:MM formatida bo‘lishi kerak (masalan, 18:30).',
...
translations.en.adminPage.breakdownUpcoming = 'Upcoming'
translations.en.adminPage.breakdownInProgress = 'In progress'
...
translations.ru.adminPage = translations.ru.adminPage ?? {}
...
translations.ru.adminPage.breakdownUpcoming = 'Предстоящие'
translations.ru.adminPage.breakdownInProgress = 'В процессе'
...
translations.uz.adminPage = translations.uz.adminPage ?? {}
...
translations.uz.adminPage.breakdownUpcoming = 'Kelayotgan'
translations.uz.adminPage.breakdownInProgress = 'Jarayonda'
