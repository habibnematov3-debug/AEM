const translations = {
  en: {
    ...
    adminPage: {
      ...
      stats: {
        users: 'Users',
        events: 'Events',
        participationsJoined: 'Joined',
        participationsWaitlisted: 'Waitlisted',
        participationsCancelled: 'Cancelled',
        checkIns: 'Check-ins',
        pending: 'Pending',
        approved: 'Approved',
        rejected: 'Rejected',
    ...
    eventDetails: {
      ...
      participantsSubtitle: 'People who joined this event.',
      ...
      checkInSuccess: 'Participant checked in.',
      checkInError: 'Could not check in this participant.',
    },
    eventCard: {
    ...
    eventForm: {
      ...
      optionalCapacity: 'Optional seat limit',
  ...
  ru: {
    ...
    eventDetails: {
      ...
      participantsSubtitle: 'Люди, присоединившиеся к событию.',
      loadingParticipants: 'Загрузка участников...',
      participantsLoadError: 'Не удалось загрузить список участников.',
      noParticipants: 'Пока участников нет.',
      checkedIn: 'Отмечен',
      checkIn: 'Отметить',
      checkingIn: 'Отмечаем...',
      checkInSuccess: 'Участник отмечен.',
      checkInError: 'Не удалось отметить участника.',
    },
    eventCard: {
    ...
    eventForm: {
      ...
      optionalCapacity: 'Необязательный лимит мест',
  ...
  uz: {
    ...
    eventDetails: {
      ...
      participantsTitle: 'Qatnashchilar',
      participantsSubtitle: 'Ushbu tadbirga qo‘shilganlar.',
      loadingParticipants: 'Qatnashchilar yuklanmoqda...',
      participantsLoadError: 'Qatnashchilar ro‘yxatini yuklab bo‘lmadi.',
      noParticipants: 'Hozircha qatnashchilar yo‘q.',
      checkedIn: 'Belgilangan',
      checkIn: 'Belgilash',
      checkingIn: 'Belgilanmoqda...',
      checkInSuccess: 'Qatnashchi belgilandi.',
      checkInError: 'Qatnashchini belgilab bo‘lmadi.',
    },
    eventCard: {
    ...
    eventForm: {
      ...
      optionalCapacity: 'Ixtiyoriy o‘rin limiti',
