const translations = {
  ...
  ru: {
    ...
    auth: {
      ...
      signinTitle: 'Войдите в свой аккаунт AEM',
      signinHelper: 'Получите доступ к событиям, своей активности и инструментам организатора в одном месте.',
      signinSubmit: 'Войти',
      signinSubmitting: 'Вход...',
      signinFooterPrompt: 'Нет аккаунта?',
      signinFooterAction: 'Создать',
      signupEyebrow: 'Создание аккаунта',
      signupTitle: 'Присоединяйтесь к AEM',
      signupHelper: 'Используйте университетский email, чтобы находить события, участвовать и создавать свои.',
  ...
  uz: {
    ...
    auth: {
      ...
      signinTitle: 'AEM akkauntingizga kiring',
      signinHelper:
        'Universitet tadbirlari, faoliyatingiz va organizator vositalariga bitta joydan kiring.',
      signinSubmit: 'Kirish',
      ...
      signupTitle: 'AEM ga qo‘shiling',
      signupHelper:
        'Universitet emailingiz bilan tadbirlarni toping, qatnashing yoki o‘zingizning tadbiringizni boshqaring.',
